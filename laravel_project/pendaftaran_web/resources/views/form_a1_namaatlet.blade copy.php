                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                                    ...
                                    <tbody id="nias-table-body" class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
                                        ...
                                        <tr class="cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 active:bg-blue-100 dark:active:bg-blue-900 selectable-row"
                                            data-athlete-id="{{ $niaspeserta->ID }}" {{-- Assuming NIAS table has an 'ID' column as primary key --}}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            tableBody.addEventListener('click', function(event) {
                const clickedRow = event.target.closest('.selectable-row'); // Get the closest row with the class
                ...
                if (clickedRow) {
                    ...
                    selectedRow = clickedRow; // Update selected row

                    // Get the data from the data-athlete-details attribute
                    const athleteDetails = JSON.parse(clickedRow.dataset.athleteDetails);

                    // Display the details (formatted for readability)
                    detailsDisplay.textContent = JSON.stringify(athleteDetails, null, 2); // null, 2 for pretty-printing
                }
            });
        });
    </script>
